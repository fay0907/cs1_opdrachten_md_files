...
namespace CalculateOpdracht1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //nu ben je jarig, tel 1 bij je leeftijd op, gebruik de variable = variabel +1; constructie 
            Console.WriteLine("Year 1 Happy birthday!");
            Console.WriteLine($"je bent nu {leeftijdStudent}" );



            //nu ben je weer jarig, tel 1 bij je leeftijd op, gebruik de += 1; constructie 
            Console.WriteLine("Year 2 Happy birthday!");
            Console.WriteLine($"je bent nu {leeftijdStudent}");


            //nu ben je weer jarig, tel 1 bij je leeftijd op, gebruik de ++; constructie
